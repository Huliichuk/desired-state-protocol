...
export const manifestSchema: JsonSchema = {
  ...
  $id: 'https://dsp.dev/schemas/v1alpha1/manifest.schema.json',
  title: 'DSP Manifest',
  type: 'object',
  additionalProperties: false,
  required: ['protocol', 'protocolVersion', 'server', 'endpoints', 'features', 'authentication', 'limits'],
  properties: {
    protocol: { const: 'dsp' },
    ...
    features: {
      ...
      properties: {
        planBeforeApply: { type: 'boolean' },
        signedPlans: { type: 'boolean' },
        idempotency: { type: 'boolean' },
        verification: { type: 'boolean' },
        auditLog: { type: 'boolean' },
        policyEvaluation: { type: 'boolean' },
    ...
    limits: {
      ...
      properties: {
        maxDocumentBytes: { type: 'integer', minimum: 1 },
        maxDocumentDepth: { type: 'integer', minimum: 1 },
        maxResources: { type: 'integer', minimum: 1 },
        maxChanges: { type: 'integer', minimum: 1 },
        planTtlSeconds: { type: 'integer', minimum: 1 },
      },
    },
  },
}
